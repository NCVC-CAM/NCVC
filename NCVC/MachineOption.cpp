// MachineOption.cpp: CMachineOption クラスのインプリメンテーション
//
//////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// CMachineOption クラスの構築/消滅

CMachineOption::CMachineOption()
{
	...
	if ( !m_strMCList.IsEmpty() )
		ReadMachineOption(m_strMCList.GetHead());
}
...
void CMachineOption::Convert(void)
{
...
BOOL CMachineOption::ReadMachineOption(LPCTSTR lpszFile, BOOL bHistory/*=TRUE*/)
{
	...
	// ----------
		...
		if ( lstrlen(szResult) > 0 ) {
			...
			// 正しいｷｰで出力
			// 　→単なる切り替えでは SaveMachineOption() が呼ばれないので
			// 　　ここで処理する
...
void CMachineOption::ConvertWorkOffset(size_t n, LPCTSTR lpszResult)
{
...
BOOL CMachineOption::AddMCListHistory(LPCTSTR lpszSearch)
{
...
optional<float> CMachineOption::GetToolD(int nTool) const
{
...
BOOL CMachineOption::AddTool(int nTool, float d, BOOL bAbs)
{
	CMCTOOLINFO*	pTool;
...
void CMachineOption::ReductionTools(BOOL bAdd)
{
	CMCTOOLINFO*	pToolInfo;
	POSITION		pos1, pos2;
...
void CMachineOption::AddMCHistory_ComboBox(CComboBox& combo)
{
...
/*
	--- 以下 MainFrm.cpp を参考
*/
CString	CMachineOption::MakeMacroCommand(int a) const
{
	CString	strResult;
