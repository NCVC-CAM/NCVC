...
BEGIN_MESSAGE_MAP(CMakeLatheSetup3, CPropertyPage)
	ON_BN_CLICKED(IDC_MKLA3_COPY, &CMakeLatheSetup3::OnCopyFromOut)
END_MESSAGE_MAP()

#define	GetParentSheet()	static_cast<CMakeLatheSetup *>(GetParentSheet())

/////////////////////////////////////////////////////////////////////////////
// CMakeLatheSetup3 プロパティ ページ

CMakeLatheSetup3::CMakeLatheSetup3() : CPropertyPage(CMakeLatheSetup3::IDD)
{
	m_psp.dwFlags &= ~PSP_HASHELP;
}

void CMakeLatheSetup3::DoDataExchange(CDataExchange* pDX)
{
...
/////////////////////////////////////////////////////////////////////////////
// CMakeLatheSetup3 メッセージ ハンドラー

BOOL CMakeLatheSetup3::OnInitDialog()
{
...
BOOL CMakeLatheSetup3::OnKillActive()
{
...
void CMakeLatheSetup3::OnCopyFromOut()
{
