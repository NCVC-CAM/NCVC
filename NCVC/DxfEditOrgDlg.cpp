...
BEGIN_MESSAGE_MAP(CDxfEditOrgDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_DXFEDIT_SEL_NUM, &CDxfEditOrgDlg::OnSelect)
	ON_BN_CLICKED(IDC_DXFEDIT_SEL_RECT, &CDxfEditOrgDlg::OnSelect)
	ON_BN_CLICKED(IDC_DXFEDIT_SEL_ORIG, &CDxfEditOrgDlg::OnSelect)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
