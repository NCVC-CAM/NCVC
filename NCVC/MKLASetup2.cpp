...
BEGIN_MESSAGE_MAP(CMKLASetup2, CPropertyPage)
	ON_BN_CLICKED(IDC_MKLA2_CYCLE, &CMKLASetup2::OnCycle)
END_MESSAGE_MAP()

#define	GetParentSheet()	static_cast<CMKLASetup *>(GetParentSheet())

/////////////////////////////////////////////////////////////////////////////
// CMKLASetup2 プロパティ ページ

CMKLASetup2::CMKLASetup2() : CPropertyPage(CMKLASetup2::IDD)
{
	m_bCycle	= FALSE;
	m_psp.dwFlags &= ~PSP_HASHELP;
}

void CMKLASetup2::DoDataExchange(CDataExchange* pDX)
{
...
void CMKLASetup2::EnableControl_Cycle(void)
{
...
/////////////////////////////////////////////////////////////////////////////
// CMKLASetup2 メッセージ ハンドラー

BOOL CMKLASetup2::OnInitDialog()
{
