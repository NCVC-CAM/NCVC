// NCVCaddinIF.cpp : CNCVCaddinIF ƒNƒ‰ƒX‚Ì“®ì‚Ì’è‹`‚ðs‚¢‚Ü‚·B
//
...
NCEXPORT LONG WINAPI NCVC_CreateRegKey(LPCTSTR lpszAddinName, PHKEY phKey)
{
	...
	strKey += strTmp + lpszAddinName;	// "Software\MNCT-S\NCVC\Addin\ÌßÛ¸Þ×Ñ–¼"
