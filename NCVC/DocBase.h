...
#define	UAV_DRAWSELECT			-7
#define	UAV_DRAWUNSELECT		-8
#define	UAV_DXFORGUPDATE		-9
#define	UAV_DXFSHAPEID			-10
#define	UAV_DXFSHAPEUPDATE		-11
#define	UAV_DXFAUTOWORKING		-12
#define	UAV_DXFAUTODELWORKING	-13
#define	UAV_DXFADDWORKING		-14
#define	UAV_DXFADDSHAPE			-15
