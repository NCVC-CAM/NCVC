...
BEGIN_MESSAGE_MAP(CViewSetup2, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_X, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_Y, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_Z, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_G0, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_G1, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_G1Z, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_CORRECT, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_CYCLE, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_CENTERCIRCLE, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_WORK, OnColorButton)
	ON_BN_CLICKED(IDC_VIEWSETUP2_BT_MAXCUT, OnColorButton)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_X, OnChange)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_Y, OnChange)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_Z, OnChange)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_G0, OnChange)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_G1, OnChange)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_G1Z, OnChange)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_CYCLE, OnChange)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_WORK, OnChange)
	ON_CBN_SELCHANGE(IDC_VIEWSETUP2_CB_MAXCUT, OnChange)
	ON_EN_CHANGE(IDC_VIEWSETUP2_X, OnChange)
	ON_EN_CHANGE(IDC_VIEWSETUP2_Y, OnChange)
	ON_EN_CHANGE(IDC_VIEWSETUP2_Z, OnChange)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
