...
class CMCTOOLINFO
{
friend	class	CMachineOption;
friend	class	CMachineSetup3;
...
class CMachineOption
{
friend	class	CMachineSetup1;
friend	class	CMachineSetup2;
friend	class	CMachineSetup3;
friend	class	CMachineSetup4;
friend	class	CMachineSetup5;
...
public:
	CMachineOption();
	~CMachineOption();
	BOOL	ReadMachineOption(LPCTSTR, BOOL = TRUE);
	BOOL	SaveMachineOption(LPCTSTR);
