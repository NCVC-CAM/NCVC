...
BEGIN_MESSAGE_MAP(CMakeNCDlgEx11, CDialog)
	...
	ON_CBN_SELCHANGE(IDC_MKNC_INIT, &CMakeNCDlgEx11::OnSelChangeInit)
	ON_CBN_KILLFOCUS(IDC_MKNC_INIT, &CMakeNCDlgEx11::OnKillFocusInit)
	ON_CBN_SELCHANGE(IDC_MKNCEX_LAYER, &CMakeNCDlgEx11::OnSelChangeLayer)
	ON_CBN_SETFOCUS(IDC_MKNCEX_LAYER, &CMakeNCDlgEx11::OnSetFocusLayer)
	ON_EN_KILLFOCUS(IDC_MKNC_NCFILE, &CMakeNCDlgEx11::OnKillFocusNCFile)
	ON_BN_CLICKED(IDC_MKNCEX_NEW, &CMakeNCDlgEx11::OnNewLayer)
	ON_BN_CLICKED(IDC_MKNC_INITUP, &CMakeNCDlgEx11::OnMKNCInitUp)
	ON_BN_CLICKED(IDC_MKNC_INITED, &CMakeNCDlgEx11::OnMKNCInitEdit)
	ON_BN_CLICKED(IDC_MKNC_NCFILEUP, &CMakeNCDlgEx11::OnMKNCFileUp)
	ON_BN_CLICKED(IDC_MKNCEX_COPY, &CMakeNCDlgEx11::OnCopy)
	ON_BN_CLICKED(IDC_MKNCEX_PARTOUT, &CMakeNCDlgEx11::OnPartOut)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
