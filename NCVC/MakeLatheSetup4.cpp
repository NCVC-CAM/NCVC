...
BEGIN_MESSAGE_MAP(CMakeLatheSetup4, CPropertyPage)
	ON_BN_CLICKED(IDC_MKLA4_ENDFACE, &CMakeLatheSetup4::OnCheck)
END_MESSAGE_MAP()

#define	GetParentSheet()	static_cast<CMakeLatheSetup *>(GetParentSheet())

/////////////////////////////////////////////////////////////////////////////
// CMakeLatheSetup4 プロパティ ページ

CMakeLatheSetup4::CMakeLatheSetup4() : CPropertyPage(CMakeLatheSetup4::IDD)
{
	m_psp.dwFlags &= ~PSP_HASHELP;
	m_bEndFace = FALSE;
}

void CMakeLatheSetup4::DoDataExchange(CDataExchange* pDX)
{
...
void CMakeLatheSetup4::EnableControl(void)
{
...
/////////////////////////////////////////////////////////////////////////////
// CMakeLatheSetup4 メッセージ ハンドラ

BOOL CMakeLatheSetup4::OnInitDialog() 
{
...
BOOL CMakeLatheSetup4::OnKillActive() 
{
