...
class CNCViewTab : public CTabViewBase, public CViewBase
{
friend	class	CTraceThread;
	...
	HDC			m_hDC[NCVIEW_FOURVIEW];	// XYZ, XY, XZ, YZ 各ﾍﾟｰｼﾞのﾃﾞﾊﾞｲｽｺﾝﾃｷｽﾄﾊﾝﾄﾞﾙ
	...
	BOOL		m_bSplit[NCVIEW_FOURVIEW];	// ｽﾌﾟﾘｯﾀ表示されたかどうか
