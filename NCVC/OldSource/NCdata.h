...
public:
	...
	virtual	void	AddBottomVertex(std::vector<VECPOINT3D>*, std::vector<VECPOINT3D>*);
...
class CNCcircle : public CNCline  
{
	...
	void	SetEndmillXYPath(VECPOINT3D&) const;
	void	SetEndmillPipe(std::vector<VECPOINT3D>*) const;
	void	SetEndmillBall(std::vector<VECPOINT3D>*) const;
