===========================================================================
【ソ フ ト名】　NCVC - NC(Gcode) Viewer and Converter Ver4.10
【登  録  名】　ncvc410.zip
【著作権  者】　眞柄　賢一
...
・NC表示
　：OpenGLタブの旋盤モードにおいて，
　　断面表示への切り替えをCtrl+左ダブルクリックからメニュー操作（Ctrl+L）に変更
　：OpenGLタブのCtrl+左ダブルクリックで，ソリッドの表示／非表示を切り替え
