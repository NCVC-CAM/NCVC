===========================================================================
【ソ フ ト名】　NCVC - NC(Gcode) Viewer and Converter Ver4.15e
【登  録  名】　ncvc415e.zip
【著作権  者】　眞柄　賢一
...
【変更履歴】
4.15d → 4.15e(2026/05/21) への変更は
・バグレポート
　：4.15dで修正した座標計算ミスに円弧補間が含まれていなかったバグを修正（Issue #34）
　　→単純ミスです．面目ない．．．

4.15c → 4.15d(2026/04/23) への変更は
・バグレポート
　：複数のワーク座標(G54～G59)と座標回転(G68)を組み合わせると，シミュレーション表示が乱れるバグを修正（Issue #34）
　　→座標計算のミスです

4.15b → 4.15c(2025/12/11) への変更は
・全般
