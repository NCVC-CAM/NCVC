===========================================================================
【ソ フ ト名】　NCVC - NC(Gcode) Viewer and Converter Ver4.12c
【登  録  名】　ncvc412c.zip
【著作権  者】　眞柄　賢一
...
4.12c → 4.xx への変更は
・バグレポート
　：変換ツールで生成したDXFを読み込むと，条件によってはNCVCが応答なしになるバグを修正（Issue #17）
　　→現実にはあり得ないような微細角度の円弧があると描画ループを抜けなくなっていた
...
4.12 → 4.12a への変更は
・バグレポート
　：固定サイクルキャンセル(G80)のあとでG00～G03のモーダルが効いていなかったバグを修正
...
ライブラリ　：MFC, boost-1.83.0, GLEW-2.10, Kodatuno-R3.4改
